...
MyOpenGL::Object* MyAssimpLoader::load(const std::string& path) {
	//拿出模型所在目录
...
//每个节点对应一个object
void MyAssimpLoader::processNode(aiNode* ainode, MyOpenGL::Object* parent, const aiScene* scene, const std::string& rootPath) {
