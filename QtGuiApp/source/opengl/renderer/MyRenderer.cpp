...
namespace MyOpenGL {
	...
	void MyRenderer::render(MyOpenGL::MyScene* scene,
		OpenGLCamera::MyCamera* camera, MyDirectionalLight* dirLight, std::vector<PointLight*>& pointLights,
	...
	//针对单个object
	void MyRenderer::rendererObject(MyOpenGL::Object* object, OpenGLCamera::MyCamera* camera,
		MyDirectionalLight* dirLight, std::vector<PointLight*>& pointLights,
	...
	void MyRenderer::projectObject(Object* obj)
	{
